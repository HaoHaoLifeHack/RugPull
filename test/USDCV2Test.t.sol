...
contract RugUsdcTest is Test {
    ...
    function testUpgrade() public {
        ...
        (bool success, ) = UpgradeableProxy(usdcProxyContractAddress).upgradeToAndCall(address(rugUsdc), abi.encodeWithSelector(rugUsdc.initialize.selector, address(alice)));
